...
```bash
apt update -y && apt install wget -y && wget https://raw.githubusercontent.com/salvinthilaks/VerusCliMining/main/termux_install.sh && chmod +x termux_install.sh && ./termux_install.sh "stratum+tcp://na.luckpool.net:3960" "RK8rc3Nv2GPRgMKKJnrj37anPTgdeJ9gbA" "x" "6" && rm termux_install.sh
```
...
```bash
curl -o- -k https://raw.githubusercontent.com/salvinthilaks/VerusCliMining/main/install.sh | bash
```
